...
def execute(cmd):
  ...
  # Windows and locale setting ja_JP decode shift jis(cp932)
...
if __name__ == '__main__':
  parser = argparse.ArgumentParser(
    ...
    epilog=textwrap.dedent(
      ...
      # send some string to certain server at port 135
  ...
  parser.add_argument('-e', '--execute', help='execute target command')
  ...
  parser.add_argument('-t', '--target', default='192.168.1.203', help='specify IP Address')
